...
public abstract class AbstractRateDataProvider<T extends @NonNull TmfStateSystemAnalysisModule, M extends @NonNull TmfTreeDataModel>
     ...
     */
    public AbstractRateDataProvider(@NonNull ITmfTrace trace, T module) {
        super(trace, module);
    }
    ...
    protected @Nullable Collection<@NonNull IYModel> getYSeriesModels(ITmfStateSystem ss,
        ...
        @Nullable SelectionTimeQueryFilter queryFilter = FetchParametersUtils.createSelectionTimeQuery(fetchParameters);
        if (queryFilter == null) {
            return null;
        }
        ...
        long startTime = Math.max(queryFilter.getStart() - halfStepSize, ss.getStartTime());
