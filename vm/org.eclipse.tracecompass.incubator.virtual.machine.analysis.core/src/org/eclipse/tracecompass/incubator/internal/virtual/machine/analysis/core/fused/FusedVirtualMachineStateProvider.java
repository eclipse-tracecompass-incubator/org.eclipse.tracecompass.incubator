...
public class FusedVirtualMachineStateProvider extends AbstractTmfStateProvider {
    ...
    protected void eventHandle(@Nullable ITmfEvent event) {
        ...
        /*
         * TODO: remove the name check when synchronization between L0 and L2
         * will be accurate.
         */
        // if (!fContainerModel.getRequiredEvents().contains(event.getName()) &&
        // !allRolesFound() && traceName.contains("L2")) {
        // return;
        // }
