 ...
 */
@NonNullByDefault
public class TimeGraphDataProvider extends AbstractTmfTraceDataProvider implements ITimeGraphDataProvider<@NonNull ITimeGraphEntryModel>, IOutputStyleProvider {

    /**
     * Provider unique ID.
     */
    public static final String ID = "org.eclipse.incubator.overhead.timegraph.dataprovider"; //$NON-NLS-1$
    ...
    private StateSystemAnalysisModule fModule;
     ...
     */
    public TimeGraphDataProvider(ITmfTrace trace, StateSystemAnalysisModule module) {
        super(trace);
        fModule = module;
    }
    ...
    public static @Nullable ITmfTreeDataProvider<? extends ITmfTreeDataModel> create(ITmfTrace trace) {
        ...
        return module != null ? new TimeGraphDataProvider(trace, module) : null;
    }
