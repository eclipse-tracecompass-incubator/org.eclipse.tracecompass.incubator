 ...
 *
 * FIXME: Patch https://git.eclipse.org/r/#/c/111411/ removed it from the main
 * repo and this and some other classes were copied here. Look at removing them
 * all.
 *
...
public class AggregateEventIterator implements Iterator<@NonNull ITimeEvent> {
    ...
    private final List<org.eclipse.tracecompass.incubator.internal.virtual.machine.analysis.ui.views.vresources.CachingIterator> fIterators = new ArrayList<>();
    ...
    public @NonNull ITimeEvent next() {
        ...
        final List<org.eclipse.tracecompass.incubator.internal.virtual.machine.analysis.ui.views.vresources.CachingIterator> iterators = fIterators;
