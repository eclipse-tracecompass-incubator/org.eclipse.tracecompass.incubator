 ...
 * <p>
 * The dialog corresponds (copy-pasted actually) to
 * {@link org.eclipse.tracecompass.internal.tmf.ui.views.timegraph.TimeEventFilterDialog}
 * to be used with the {@link BaseDataProviderTimeGraphMultiViewer}.
 *
...
public class TimeEventFilterDialog extends Dialog {
    ...
    private final AbstractTimeGraphMultiViewer fViewer;
     ...
     * @param control
     *            The timegraph control
     */
    public TimeEventFilterDialog(Shell parentShell, AbstractTimeGraphMultiViewer view, TimeGraphControl control) {
        super(parentShell);
        fViewer = view;
        fControl = control;
    }
