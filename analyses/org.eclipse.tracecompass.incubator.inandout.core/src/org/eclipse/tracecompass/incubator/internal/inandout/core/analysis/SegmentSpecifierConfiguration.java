...
public class SegmentSpecifierConfiguration {
    ...
    /**
     * Converts JSON string for InAndOut specifiers
     *
     ...
     */
    public static SegmentSpecifierConfiguration fromJsonString(String jsonParameters) throws TmfConfigurationException {
        try {
