...
public interface ConfigurationParameterDescriptor {
     ...
     */
    @Schema(description = "Optinal flag indicating whether the configuration parameter is required or not. If ommitted the default value is false.", requiredMode = RequiredMode.REQUIRED)
    Boolean isRequired();
}
