...
public class Annotation {
  ...
  public Annotation entryId(Long entryId) {
  ...
  public Annotation style(OutputElementStyle style) {
    this.style = style;
    return this;
  }
  ...
  public Annotation time(Long time) {
    this.time = time;
    return this;
  }
  ...
  public Annotation duration(Long duration) {
