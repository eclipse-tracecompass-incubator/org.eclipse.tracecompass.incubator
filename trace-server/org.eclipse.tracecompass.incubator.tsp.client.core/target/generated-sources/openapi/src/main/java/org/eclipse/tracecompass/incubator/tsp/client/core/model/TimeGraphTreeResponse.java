 ...
 */
@JsonPropertyOrder({
  TimeGraphTreeResponse.JSON_PROPERTY_STATUS_MESSAGE,
  TimeGraphTreeResponse.JSON_PROPERTY_STATUS,
  TimeGraphTreeResponse.JSON_PROPERTY_MODEL
})
...
public class TimeGraphTreeResponse {
  ...
  private TimeGraphTreeModel model;

  public TimeGraphTreeResponse() { 
  }

  public TimeGraphTreeResponse statusMessage(@javax.annotation.Nonnull String statusMessage) {
  ...
  public TimeGraphTreeResponse status(@javax.annotation.Nonnull StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public TimeGraphTreeResponse model(@javax.annotation.Nullable TimeGraphTreeModel model) {
    this.model = model;
    return this;
  }
  ...
  public TimeGraphTreeModel getModel() {
    return model;
  }
  ...
  @JsonProperty(JSON_PROPERTY_MODEL)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setModel(@javax.annotation.Nullable TimeGraphTreeModel model) {
    this.model = model;
  }


  /**
   * Return true if this TimeGraphTreeResponse object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    TimeGraphTreeResponse timeGraphTreeResponse = (TimeGraphTreeResponse) o;
    return Objects.equals(this.statusMessage, timeGraphTreeResponse.statusMessage) &&
        Objects.equals(this.status, timeGraphTreeResponse.status) &&
        Objects.equals(this.model, timeGraphTreeResponse.model);
  }
  ...
  public String toString() {
    ...
    sb.append("class TimeGraphTreeResponse {\n");
