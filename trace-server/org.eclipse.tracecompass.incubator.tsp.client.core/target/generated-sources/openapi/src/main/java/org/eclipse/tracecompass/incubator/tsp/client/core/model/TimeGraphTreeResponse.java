...
public class TimeGraphTreeResponse {
  ...
  public TimeGraphTreeResponse statusMessage(String statusMessage) {
  ...
  public TimeGraphTreeResponse status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public TimeGraphTreeResponse model(TimeGraphTreeModel model) {
    this.model = model;
    return this;
  }
  ...
  @JsonProperty(JSON_PROPERTY_MODEL)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setModel(TimeGraphTreeModel model) {
    this.model = model;
  }
