...
public class GenericXyApi {
   ...
   */
  public XYResponse getGenericXY(UUID expUUID, String outputId, GenericXYQueryParameters genericXYQueryParameters) throws ApiException {
   ...
   */
  public ApiResponse<XYResponse> getGenericXYWithHttpInfo(UUID expUUID, String outputId, GenericXYQueryParameters genericXYQueryParameters) throws ApiException {
   ...
   */
  public XYTreeResponse getGenericXYChartTree(UUID expUUID, String outputId, TreeQueryParameters treeQueryParameters) throws ApiException {
   ...
   */
  public ApiResponse<XYTreeResponse> getGenericXYChartTreeWithHttpInfo(UUID expUUID, String outputId, TreeQueryParameters treeQueryParameters) throws ApiException {
    // Check required parameters
    if (expUUID == null) {
