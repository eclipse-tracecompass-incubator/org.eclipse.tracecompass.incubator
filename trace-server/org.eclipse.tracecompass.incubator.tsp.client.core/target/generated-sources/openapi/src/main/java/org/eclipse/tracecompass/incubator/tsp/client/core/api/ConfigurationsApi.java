...
public class ConfigurationsApi {
   ...
   */
  public ModelConfiguration deleteConfiguration(String typeId, String configId) throws ApiException {
   ...
   */
  public ApiResponse<ModelConfiguration> deleteConfigurationWithHttpInfo(String typeId, String configId) throws ApiException {
   ...
   */
  public ModelConfiguration getConfiguration(String typeId, String configId) throws ApiException {
   ...
   */
  public ApiResponse<ModelConfiguration> getConfigurationWithHttpInfo(String typeId, String configId) throws ApiException {
    // Check required parameters
    if (typeId == null) {
   ...
   */
  public ConfigurationSourceType getConfigurationType(String typeId) throws ApiException {
   ...
   */
  public ApiResponse<ConfigurationSourceType> getConfigurationTypeWithHttpInfo(String typeId) throws ApiException {
    // Check required parameters
    if (typeId == null) {
   ...
   */
  public List<ModelConfiguration> getConfigurations(String typeId) throws ApiException {
   ...
   */
  public ApiResponse<List<ModelConfiguration>> getConfigurationsWithHttpInfo(String typeId) throws ApiException {
    // Check required parameters
    if (typeId == null) {
   ...
   */
  public ModelConfiguration postConfiguration(String typeId, ConfigurationQueryParameters configurationQueryParameters) throws ApiException {
   ...
   */
  public ApiResponse<ModelConfiguration> postConfigurationWithHttpInfo(String typeId, ConfigurationQueryParameters configurationQueryParameters) throws ApiException {
    // Check required parameters
    if (typeId == null) {
   ...
   */
  public ModelConfiguration putConfiguration(String typeId, String configId, ConfigurationQueryParameters configurationQueryParameters) throws ApiException {
   ...
   */
  public ApiResponse<ModelConfiguration> putConfigurationWithHttpInfo(String typeId, String configId, ConfigurationQueryParameters configurationQueryParameters) throws ApiException {
    // Check required parameters
    if (typeId == null) {
