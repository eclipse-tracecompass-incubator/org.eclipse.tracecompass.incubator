...
public class VirtualTableLine {
  ...
  public VirtualTableLine tags(Integer tags) {
    this.tags = tags;
    return this;
  }
  ...
  public VirtualTableLine cells(List<VirtualTableCell> cells) {
    this.cells = cells;
    return this;
  }
  ...
  @JsonProperty(JSON_PROPERTY_CELLS)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setCells(List<VirtualTableCell> cells) {
    this.cells = cells;
  }


  public VirtualTableLine index(Long index) {
    this.index = index;
    return this;
  }
