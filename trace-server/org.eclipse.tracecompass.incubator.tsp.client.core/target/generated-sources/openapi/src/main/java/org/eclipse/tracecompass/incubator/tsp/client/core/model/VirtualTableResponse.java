...
public class VirtualTableResponse {
  ...
  public VirtualTableResponse statusMessage(String statusMessage) {
  ...
  public VirtualTableResponse status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public VirtualTableResponse model(VirtualTableModel model) {
    this.model = model;
    return this;
  }
