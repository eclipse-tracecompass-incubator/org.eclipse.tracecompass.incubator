 ...
 */
@JsonPropertyOrder({
  VirtualTableResponse.JSON_PROPERTY_STATUS_MESSAGE,
...
public class VirtualTableResponse {
  ...
  private VirtualTableModel model;

  public VirtualTableResponse() { 
  }

  public VirtualTableResponse statusMessage(@javax.annotation.Nonnull String statusMessage) {
  ...
  public VirtualTableResponse status(@javax.annotation.Nonnull StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public VirtualTableResponse model(@javax.annotation.Nullable VirtualTableModel model) {
    this.model = model;
    return this;
  }
  ...
  public VirtualTableModel getModel() {
    return model;
  }
  ...
  @JsonProperty(JSON_PROPERTY_MODEL)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setModel(@javax.annotation.Nullable VirtualTableModel model) {
    this.model = model;
  }


  /**
   * Return true if this VirtualTableResponse object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    VirtualTableResponse virtualTableResponse = (VirtualTableResponse) o;
    return Objects.equals(this.statusMessage, virtualTableResponse.statusMessage) &&
        Objects.equals(this.status, virtualTableResponse.status) &&
        Objects.equals(this.model, virtualTableResponse.model);
  }
  ...
  public String toString() {
    ...
    sb.append("class VirtualTableResponse {\n");
