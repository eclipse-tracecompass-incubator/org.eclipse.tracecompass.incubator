...
public class LinesParameters {
  ...
  public LinesParameters requestedTableIndex(Long requestedTableIndex) {
  ...
  @JsonProperty(JSON_PROPERTY_REQUESTED_TABLE_INDEX)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRequestedTableIndex(Long requestedTableIndex) {
    this.requestedTableIndex = requestedTableIndex;
  }


  public LinesParameters requestedTimes(List<Long> requestedTimes) {
  ...
  @JsonProperty(JSON_PROPERTY_REQUESTED_TIMES)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRequestedTimes(List<Long> requestedTimes) {
    this.requestedTimes = requestedTimes;
  }


  public LinesParameters requestedTableCount(Integer requestedTableCount) {
  ...
  @JsonProperty(JSON_PROPERTY_REQUESTED_TABLE_COUNT)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setRequestedTableCount(Integer requestedTableCount) {
    this.requestedTableCount = requestedTableCount;
  }


  public LinesParameters requestedTableColumnIds(List<Long> requestedTableColumnIds) {
  ...
  @JsonProperty(JSON_PROPERTY_REQUESTED_TABLE_COLUMN_IDS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRequestedTableColumnIds(List<Long> requestedTableColumnIds) {
    this.requestedTableColumnIds = requestedTableColumnIds;
  }


  public LinesParameters tableSearchExpressions(Map<String, String> tableSearchExpressions) {
  ...
  @JsonProperty(JSON_PROPERTY_TABLE_SEARCH_EXPRESSIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setTableSearchExpressions(Map<String, String> tableSearchExpressions) {
    this.tableSearchExpressions = tableSearchExpressions;
  }


  public LinesParameters tableSearchDirection(TableSearchDirectionEnum tableSearchDirection) {
  ...
  @JsonProperty(JSON_PROPERTY_TABLE_SEARCH_DIRECTION)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setTableSearchDirection(TableSearchDirectionEnum tableSearchDirection) {
    this.tableSearchDirection = tableSearchDirection;
  }
