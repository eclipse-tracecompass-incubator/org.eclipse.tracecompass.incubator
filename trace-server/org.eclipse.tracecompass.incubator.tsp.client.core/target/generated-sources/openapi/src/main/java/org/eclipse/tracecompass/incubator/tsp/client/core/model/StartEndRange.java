 ...
 */
@JsonPropertyOrder({
  StartEndRange.JSON_PROPERTY_START,
  StartEndRange.JSON_PROPERTY_END
})
...
public class StartEndRange {
  ...
  public StartEndRange() { 
  }

  public StartEndRange start(@javax.annotation.Nonnull Long start) {
    this.start = start;
    return this;
  }
  ...
  public StartEndRange end(@javax.annotation.Nonnull Long end) {
    this.end = end;
    return this;
  }
  ...
  /**
   * Return true if this StartEndRange object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    StartEndRange startEndRange = (StartEndRange) o;
    return Objects.equals(this.start, startEndRange.start) &&
        Objects.equals(this.end, startEndRange.end);
  }
