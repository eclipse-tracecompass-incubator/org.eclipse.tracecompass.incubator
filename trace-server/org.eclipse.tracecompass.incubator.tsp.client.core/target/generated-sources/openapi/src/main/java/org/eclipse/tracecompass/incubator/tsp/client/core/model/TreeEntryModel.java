...
public class TreeEntryModel {
  ...
  public TreeEntryModel autoExpandLevel(@javax.annotation.Nullable Integer autoExpandLevel) {
  ...
  public TreeEntryModel entries(@javax.annotation.Nonnull List<TreeDataModel> entries) {
  ...
  @JsonProperty(JSON_PROPERTY_ENTRIES)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setEntries(@javax.annotation.Nonnull List<TreeDataModel> entries) {
    this.entries = entries;
  }


  public TreeEntryModel headers(@javax.annotation.Nonnull List<TreeColumnHeader> headers) {
