...
public class DataTreeApi {
   ...
   */
  public DataTreeResponse getDataTree(UUID expUUID, String outputId, TreeQueryParameters treeQueryParameters) throws ApiException {
   ...
   */
  public ApiResponse<DataTreeResponse> getDataTreeWithHttpInfo(UUID expUUID, String outputId, TreeQueryParameters treeQueryParameters) throws ApiException {
