...
public class AnnotationResponse {
  ...
  public AnnotationResponse statusMessage(String statusMessage) {
  ...
  public AnnotationResponse status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public AnnotationResponse model(AnnotationModel model) {
    this.model = model;
    return this;
  }
