...
public class TimeGraphState {
  ...
  public TimeGraphState tags(Integer tags) {
    this.tags = tags;
    return this;
  }
  ...
  public TimeGraphState end(Long end) {
    this.end = end;
    return this;
  }
  ...
  public TimeGraphState style(OutputElementStyle style) {
    this.style = style;
    return this;
  }
  ...
  public TimeGraphState label(String label) {
    this.label = label;
    return this;
  }
  ...
  public TimeGraphState start(Long start) {
    this.start = start;
    return this;
  }
