 ...
 */
@JsonPropertyOrder({
  TimeGraphTreeModel.JSON_PROPERTY_AUTO_EXPAND_LEVEL,
...
public class TimeGraphTreeModel {
  ...
  private List<TimeGraphEntry> entries = new ArrayList<>();
  ...
  public TimeGraphTreeModel autoExpandLevel(Integer autoExpandLevel) {
  ...
  public TimeGraphTreeModel entries(List<TimeGraphEntry> entries) {
    this.entries = entries;
    return this;
  }

  public TimeGraphTreeModel addEntriesItem(TimeGraphEntry entriesItem) {
  ...
  @JsonProperty(JSON_PROPERTY_ENTRIES)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setEntries(List<TimeGraphEntry> entries) {
    this.entries = entries;
  }


  public TimeGraphTreeModel headers(List<TreeColumnHeader> headers) {
    this.headers = headers;
    return this;
  }

  public TimeGraphTreeModel addHeadersItem(TreeColumnHeader headersItem) {
  ...
  /**
   * Return true if this TimeGraphTreeModel object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    TimeGraphTreeModel timeGraphTreeModel = (TimeGraphTreeModel) o;
    return Objects.equals(this.autoExpandLevel, timeGraphTreeModel.autoExpandLevel) &&
        Objects.equals(this.entries, timeGraphTreeModel.entries) &&
        Objects.equals(this.headers, timeGraphTreeModel.headers);
  }
  ...
  public String toString() {
    ...
    sb.append("class TimeGraphTreeModel {\n");
