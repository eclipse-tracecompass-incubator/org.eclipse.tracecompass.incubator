...
public class TimeGraphTreeModel {
  ...
  public TimeGraphTreeModel autoExpandLevel(@javax.annotation.Nullable Integer autoExpandLevel) {
  ...
  public TimeGraphTreeModel entries(@javax.annotation.Nonnull List<TimeGraphEntry> entries) {
  ...
  @JsonProperty(JSON_PROPERTY_ENTRIES)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setEntries(@javax.annotation.Nonnull List<TimeGraphEntry> entries) {
    this.entries = entries;
  }


  public TimeGraphTreeModel headers(@javax.annotation.Nonnull List<TreeColumnHeader> headers) {
