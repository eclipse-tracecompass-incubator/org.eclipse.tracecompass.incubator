...
public class TracesApi {
   ...
   */
  public Trace deleteTrace(UUID uuid) throws ApiException {
   ...
   */
  public ApiResponse<Trace> deleteTraceWithHttpInfo(UUID uuid) throws ApiException {
   ...
   */
  public Trace getTrace(UUID uuid) throws ApiException {
   ...
   */
  public ApiResponse<Trace> getTraceWithHttpInfo(UUID uuid) throws ApiException {
    // Check required parameters
    if (uuid == null) {
   ...
   */
  public Trace putTrace(TraceQueryParameters traceQueryParameters) throws ApiException {
   ...
   */
  public ApiResponse<Trace> putTraceWithHttpInfo(TraceQueryParameters traceQueryParameters) throws ApiException {
    // Check required parameters
