...
public class OutputElementStyle {
  ...
  public OutputElementStyle parentKey(String parentKey) {
  ...
  public OutputElementStyle values(Map<String, StyleValue> values) {
    this.values = values;
    return this;
  }
  ...
  @JsonProperty(JSON_PROPERTY_VALUES)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setValues(Map<String, StyleValue> values) {
    this.values = values;
  }
