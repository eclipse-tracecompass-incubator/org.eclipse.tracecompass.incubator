 ...
 */
@JsonPropertyOrder({
  AnnotationsQueryParameters.JSON_PROPERTY_PARAMETERS
})
...
public class AnnotationsQueryParameters {
  public static final String JSON_PROPERTY_PARAMETERS = "parameters";
  @javax.annotation.Nonnull
  private AnnotationsParameters parameters;

  public AnnotationsQueryParameters() { 
  }

  public AnnotationsQueryParameters parameters(@javax.annotation.Nonnull AnnotationsParameters parameters) {
  ...
  public AnnotationsParameters getParameters() {
    return parameters;
  }
  ...
  @JsonProperty(JSON_PROPERTY_PARAMETERS)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setParameters(@javax.annotation.Nonnull AnnotationsParameters parameters) {
    this.parameters = parameters;
  }


  /**
   * Return true if this AnnotationsQueryParameters object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    AnnotationsQueryParameters annotationsQueryParameters = (AnnotationsQueryParameters) o;
    return Objects.equals(this.parameters, annotationsQueryParameters.parameters);
  }
  ...
  public String toString() {
    ...
    sb.append("class AnnotationsQueryParameters {\n");
