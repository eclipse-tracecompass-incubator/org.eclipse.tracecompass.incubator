 ...
 */
@JsonPropertyOrder({
  AxisDomainRange.JSON_PROPERTY_START,
  AxisDomainRange.JSON_PROPERTY_END,
  AxisDomainRange.JSON_PROPERTY_TYPE
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.15.0")
public class AxisDomainRange {
  ...
  public AxisDomainRange start(@javax.annotation.Nonnull Long start) {
    this.start = start;
    return this;
  }
  ...
  public AxisDomainRange end(@javax.annotation.Nonnull Long end) {
    this.end = end;
    return this;
  }
  ...
  public AxisDomainRange type(@javax.annotation.Nonnull String type) {
    this.type = type;
    return this;
  }

  /**
   * Type of axis domain: &#39;range&#39;
   * @return type
   */
  @javax.annotation.Nonnull
  ...
  /**
   * Return true if this AxisDomainRange object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    AxisDomainRange axisDomainRange = (AxisDomainRange) o;
    return Objects.equals(this.start, axisDomainRange.start) &&
        Objects.equals(this.end, axisDomainRange.end) &&
        Objects.equals(this.type, axisDomainRange.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class AxisDomainRange {\n");
