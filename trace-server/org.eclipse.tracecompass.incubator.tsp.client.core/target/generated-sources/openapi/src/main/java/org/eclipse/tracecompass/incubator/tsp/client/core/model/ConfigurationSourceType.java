...
public class ConfigurationSourceType {
  ...
  public ConfigurationSourceType parameterDescriptors(List<ConfigurationParameterDescriptor> parameterDescriptors) {
  ...
  @JsonProperty(JSON_PROPERTY_PARAMETER_DESCRIPTORS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setParameterDescriptors(List<ConfigurationParameterDescriptor> parameterDescriptors) {
    this.parameterDescriptors = parameterDescriptors;
  }


  public ConfigurationSourceType description(String description) {
  ...
  public ConfigurationSourceType name(String name) {
    this.name = name;
    return this;
  }
  ...
  public ConfigurationSourceType id(String id) {
    this.id = id;
    return this;
  }
  ...
  public ConfigurationSourceType schema(Object schema) {
    this.schema = schema;
    return this;
  }
