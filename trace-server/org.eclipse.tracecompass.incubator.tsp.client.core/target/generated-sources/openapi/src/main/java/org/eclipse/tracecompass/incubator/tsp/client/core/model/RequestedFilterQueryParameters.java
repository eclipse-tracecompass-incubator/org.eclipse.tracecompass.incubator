...
public class RequestedFilterQueryParameters {
  ...
  public RequestedFilterQueryParameters filterExpressionsMap(Map<String, List<String>> filterExpressionsMap) {
  ...
  @JsonProperty(JSON_PROPERTY_FILTER_EXPRESSIONS_MAP)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setFilterExpressionsMap(Map<String, List<String>> filterExpressionsMap) {
    this.filterExpressionsMap = filterExpressionsMap;
  }


  public RequestedFilterQueryParameters strategy(StrategyEnum strategy) {
