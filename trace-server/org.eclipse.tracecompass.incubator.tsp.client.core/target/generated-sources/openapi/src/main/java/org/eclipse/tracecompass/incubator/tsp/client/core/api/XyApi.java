...
public class XyApi {
   ...
   */
  public XYResponse getXY(UUID expUUID, String outputId, RequestedQueryParameters requestedQueryParameters) throws ApiException {
   ...
   */
  public ApiResponse<XYResponse> getXYWithHttpInfo(UUID expUUID, String outputId, RequestedQueryParameters requestedQueryParameters) throws ApiException {
   ...
   */
  public XYTreeResponse getXYTree(UUID expUUID, String outputId, TreeQueryParameters treeQueryParameters) throws ApiException {
   ...
   */
  public ApiResponse<XYTreeResponse> getXYTreeWithHttpInfo(UUID expUUID, String outputId, TreeQueryParameters treeQueryParameters) throws ApiException {
    // Check required parameters
    if (expUUID == null) {
