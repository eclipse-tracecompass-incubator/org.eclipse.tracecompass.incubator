 ...
 */
@JsonPropertyOrder({
  XYTreeEntry.JSON_PROPERTY_HAS_DATA,
  XYTreeEntry.JSON_PROPERTY_PARENT_ID,
  XYTreeEntry.JSON_PROPERTY_STYLE,
  XYTreeEntry.JSON_PROPERTY_ID,
...
public class XYTreeEntry {
  ...
  public XYTreeEntry hasData(@javax.annotation.Nullable Boolean hasData) {
  ...
  public XYTreeEntry parentId(@javax.annotation.Nullable Long parentId) {
  ...
  public XYTreeEntry style(@javax.annotation.Nullable OutputElementStyle style) {
    this.style = style;
    return this;
  }
  ...
  public XYTreeEntry id(@javax.annotation.Nonnull Long id) {
    this.id = id;
    return this;
  }
  ...
  public XYTreeEntry labels(@javax.annotation.Nonnull List<String> labels) {
    this.labels = labels;
    return this;
  }

  public XYTreeEntry addLabelsItem(String labelsItem) {
    if (this.labels == null) {
  ...
  public XYTreeEntry isDefault(@javax.annotation.Nullable Boolean isDefault) {
    this.isDefault = isDefault;
    return this;
  }

  /**
   * Optional flag to indicate whether or not the entry is a default entry and its xy data should be fetched by default.
   * @return isDefault
   */
  @javax.annotation.Nullable
  ...
  /**
   * Return true if this XYTreeEntry object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    XYTreeEntry xyTreeEntry = (XYTreeEntry) o;
    return Objects.equals(this.hasData, xyTreeEntry.hasData) &&
        Objects.equals(this.parentId, xyTreeEntry.parentId) &&
        Objects.equals(this.style, xyTreeEntry.style) &&
        Objects.equals(this.id, xyTreeEntry.id) &&
        Objects.equals(this.labels, xyTreeEntry.labels) &&
        Objects.equals(this.isDefault, xyTreeEntry.isDefault);
  }

  @Override
  public int hashCode() {
    return Objects.hash(hasData, parentId, style, id, labels, isDefault);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class XYTreeEntry {\n");
