...
public class XYTreeEntry {
  ...
  public XYTreeEntry hasData(Boolean hasData) {
  ...
  public XYTreeEntry parentId(Long parentId) {
  ...
  public XYTreeEntry style(OutputElementStyle style) {
    this.style = style;
    return this;
  }
  ...
  public XYTreeEntry labels(List<String> labels) {
    this.labels = labels;
    return this;
  }
  ...
  public XYTreeEntry isDefault(Boolean isDefault) {
