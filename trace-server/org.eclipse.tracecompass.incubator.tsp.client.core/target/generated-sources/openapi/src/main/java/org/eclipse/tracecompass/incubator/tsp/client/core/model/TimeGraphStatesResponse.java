 ...
 */
@JsonPropertyOrder({
  TimeGraphStatesResponse.JSON_PROPERTY_STATUS_MESSAGE,
...
public class TimeGraphStatesResponse {
  ...
  public TimeGraphStatesResponse() { 
  }

  public TimeGraphStatesResponse statusMessage(@javax.annotation.Nonnull String statusMessage) {
  ...
  public TimeGraphStatesResponse status(@javax.annotation.Nonnull StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public TimeGraphStatesResponse model(@javax.annotation.Nullable TimeGraphModel model) {
    this.model = model;
    return this;
  }
  ...
  @JsonProperty(JSON_PROPERTY_MODEL)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setModel(@javax.annotation.Nullable TimeGraphModel model) {
    this.model = model;
  }


  /**
   * Return true if this TimeGraphStatesResponse object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    TimeGraphStatesResponse timeGraphStatesResponse = (TimeGraphStatesResponse) o;
    return Objects.equals(this.statusMessage, timeGraphStatesResponse.statusMessage) &&
        Objects.equals(this.status, timeGraphStatesResponse.status) &&
        Objects.equals(this.model, timeGraphStatesResponse.model);
  }
  ...
  public String toString() {
    ...
    sb.append("class TimeGraphStatesResponse {\n");
