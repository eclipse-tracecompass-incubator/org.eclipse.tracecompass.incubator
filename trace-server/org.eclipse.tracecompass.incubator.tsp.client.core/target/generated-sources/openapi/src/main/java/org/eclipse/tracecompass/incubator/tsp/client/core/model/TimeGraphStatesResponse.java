...
public class TimeGraphStatesResponse {
  ...
  public TimeGraphStatesResponse statusMessage(String statusMessage) {
  ...
  public TimeGraphStatesResponse status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public TimeGraphStatesResponse model(TimeGraphModel model) {
    this.model = model;
    return this;
  }
