...
public class TreeDataModel {
  ...
  public TreeDataModel hasData(Boolean hasData) {
  ...
  public TreeDataModel parentId(Long parentId) {
  ...
  public TreeDataModel style(OutputElementStyle style) {
    this.style = style;
    return this;
  }
  ...
  public TreeDataModel id(Long id) {
    this.id = id;
    return this;
  }
  ...
  public TreeDataModel labels(List<String> labels) {
    this.labels = labels;
    return this;
  }
