...
public class MarkerSetsResponse {
  ...
  public MarkerSetsResponse statusMessage(String statusMessage) {
  ...
  public MarkerSetsResponse status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public MarkerSetsResponse model(List<MarkerSet> model) {
    this.model = model;
    return this;
  }
  ...
  @JsonProperty(JSON_PROPERTY_MODEL)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setModel(List<MarkerSet> model) {
    this.model = model;
  }
