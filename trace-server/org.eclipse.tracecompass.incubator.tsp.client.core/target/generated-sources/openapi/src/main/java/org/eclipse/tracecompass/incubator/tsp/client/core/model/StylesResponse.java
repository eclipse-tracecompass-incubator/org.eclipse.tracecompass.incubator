...
public class StylesResponse {
  ...
  public StylesResponse statusMessage(String statusMessage) {
  ...
  public StylesResponse status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public StylesResponse model(OutputStyleModel model) {
    this.model = model;
    return this;
  }
  ...
  @JsonProperty(JSON_PROPERTY_MODEL)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setModel(OutputStyleModel model) {
    this.model = model;
  }
