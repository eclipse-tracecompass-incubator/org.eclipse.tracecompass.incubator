 ...
 */
@JsonPropertyOrder({
  StylesResponse.JSON_PROPERTY_STATUS_MESSAGE,
  StylesResponse.JSON_PROPERTY_STATUS,
  StylesResponse.JSON_PROPERTY_MODEL
})
...
public class StylesResponse {
  ...
  private OutputStyleModel model;

  public StylesResponse() { 
  }

  public StylesResponse statusMessage(@javax.annotation.Nonnull String statusMessage) {
  ...
  public StylesResponse status(@javax.annotation.Nonnull StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public StylesResponse model(@javax.annotation.Nullable OutputStyleModel model) {
    this.model = model;
    return this;
  }
  ...
  public OutputStyleModel getModel() {
    return model;
  }
  ...
  @JsonProperty(JSON_PROPERTY_MODEL)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setModel(@javax.annotation.Nullable OutputStyleModel model) {
    this.model = model;
  }


  /**
   * Return true if this StylesResponse object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.statusMessage, stylesResponse.statusMessage) &&
        Objects.equals(this.status, stylesResponse.status) &&
        Objects.equals(this.model, stylesResponse.model);
  }
