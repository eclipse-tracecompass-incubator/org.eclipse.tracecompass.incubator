 ...
 */
@JsonPropertyOrder({
  TreeQueryParameters.JSON_PROPERTY_PARAMETERS
})
...
public class TreeQueryParameters {
  ...
  public TreeQueryParameters() { 
  }

  public TreeQueryParameters parameters(@javax.annotation.Nonnull TreeParameters parameters) {
  ...
  @JsonProperty(JSON_PROPERTY_PARAMETERS)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setParameters(@javax.annotation.Nonnull TreeParameters parameters) {
    this.parameters = parameters;
  }


  /**
   * Return true if this TreeQueryParameters object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    TreeQueryParameters treeQueryParameters = (TreeQueryParameters) o;
    return Objects.equals(this.parameters, treeQueryParameters.parameters);
  }
  ...
  public String toString() {
    ...
    sb.append("class TreeQueryParameters {\n");
