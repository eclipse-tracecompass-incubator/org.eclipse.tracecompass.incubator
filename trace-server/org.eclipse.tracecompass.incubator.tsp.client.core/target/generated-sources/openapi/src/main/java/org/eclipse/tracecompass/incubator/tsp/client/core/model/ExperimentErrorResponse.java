...
public class ExperimentErrorResponse {
  ...
  public ExperimentErrorResponse detail(String detail) {
    this.detail = detail;
    return this;
  }
  ...
  public ExperimentErrorResponse title(String title) {
    this.title = title;
    return this;
  }
  ...
  public ExperimentErrorResponse experiment(Experiment experiment) {
