 ...
 */
@JsonPropertyOrder({
  DataTreeResponse.JSON_PROPERTY_STATUS_MESSAGE,
  DataTreeResponse.JSON_PROPERTY_STATUS,
  DataTreeResponse.JSON_PROPERTY_MODEL
})
...
public class DataTreeResponse {
  ...
  private DataTreeEntryModel model;

  public DataTreeResponse() { 
  }

  public DataTreeResponse statusMessage(@javax.annotation.Nonnull String statusMessage) {
  ...
  public DataTreeResponse status(@javax.annotation.Nonnull StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public DataTreeResponse model(@javax.annotation.Nullable DataTreeEntryModel model) {
    this.model = model;
    return this;
  }
  ...
  public DataTreeEntryModel getModel() {
    return model;
  }
  ...
  @JsonProperty(JSON_PROPERTY_MODEL)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setModel(@javax.annotation.Nullable DataTreeEntryModel model) {
    this.model = model;
  }


  /**
   * Return true if this DataTreeResponse object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    DataTreeResponse dataTreeResponse = (DataTreeResponse) o;
    return Objects.equals(this.statusMessage, dataTreeResponse.statusMessage) &&
        Objects.equals(this.status, dataTreeResponse.status) &&
        Objects.equals(this.model, dataTreeResponse.model);
  }
  ...
  public String toString() {
    ...
    sb.append("class DataTreeResponse {\n");
