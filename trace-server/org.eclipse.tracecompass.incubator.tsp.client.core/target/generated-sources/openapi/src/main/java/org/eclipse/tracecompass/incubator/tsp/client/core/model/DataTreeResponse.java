...
public class DataTreeResponse {
  ...
  public DataTreeResponse statusMessage(String statusMessage) {
  ...
  public DataTreeResponse status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public DataTreeResponse model(DataTreeEntryModel model) {
    this.model = model;
    return this;
  }
  ...
  @JsonProperty(JSON_PROPERTY_MODEL)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setModel(DataTreeEntryModel model) {
    this.model = model;
  }
