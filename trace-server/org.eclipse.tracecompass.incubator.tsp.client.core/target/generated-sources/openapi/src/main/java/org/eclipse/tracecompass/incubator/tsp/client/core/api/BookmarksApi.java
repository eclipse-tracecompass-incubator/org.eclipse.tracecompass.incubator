...
public class BookmarksApi {
   ...
   */
  public Bookmark createBookmark(UUID expUUID, BookmarkQueryParameters bookmarkQueryParameters) throws ApiException {
   ...
   */
  public ApiResponse<Bookmark> createBookmarkWithHttpInfo(UUID expUUID, BookmarkQueryParameters bookmarkQueryParameters) throws ApiException {
   ...
   */
  public Bookmark deleteBookmark(UUID expUUID, UUID bookmarkUUID) throws ApiException {
   ...
   */
  public ApiResponse<Bookmark> deleteBookmarkWithHttpInfo(UUID expUUID, UUID bookmarkUUID) throws ApiException {
    // Check required parameters
    if (expUUID == null) {
   ...
   */
  public Bookmark getBookmark(UUID expUUID, UUID bookmarkUUID) throws ApiException {
   ...
   */
  public ApiResponse<Bookmark> getBookmarkWithHttpInfo(UUID expUUID, UUID bookmarkUUID) throws ApiException {
    // Check required parameters
    if (expUUID == null) {
   ...
   */
  public List<Bookmark> getBookmarks(UUID expUUID) throws ApiException {
   ...
   */
  public ApiResponse<List<Bookmark>> getBookmarksWithHttpInfo(UUID expUUID) throws ApiException {
    // Check required parameters
    if (expUUID == null) {
   ...
   */
  public Bookmark updateBookmark(UUID expUUID, UUID bookmarkUUID, BookmarkQueryParameters bookmarkQueryParameters) throws ApiException {
   ...
   */
  public ApiResponse<Bookmark> updateBookmarkWithHttpInfo(UUID expUUID, UUID bookmarkUUID, BookmarkQueryParameters bookmarkQueryParameters) throws ApiException {
    // Check required parameters
    if (expUUID == null) {
