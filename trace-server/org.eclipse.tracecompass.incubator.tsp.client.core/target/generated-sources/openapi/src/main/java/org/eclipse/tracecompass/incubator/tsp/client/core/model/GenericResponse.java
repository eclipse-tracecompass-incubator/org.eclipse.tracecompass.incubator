...
/**
 * Response that includes the status and a status message
 */
@JsonPropertyOrder({
  GenericResponse.JSON_PROPERTY_STATUS_MESSAGE,
...
public class GenericResponse {
  ...
  public GenericResponse statusMessage(@javax.annotation.Nonnull String statusMessage) {
  ...
  public GenericResponse status(@javax.annotation.Nonnull StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.statusMessage, genericResponse.statusMessage) &&
        Objects.equals(this.status, genericResponse.status);
  }

  @Override
  public int hashCode() {
    return Objects.hash(statusMessage, status);
  }
