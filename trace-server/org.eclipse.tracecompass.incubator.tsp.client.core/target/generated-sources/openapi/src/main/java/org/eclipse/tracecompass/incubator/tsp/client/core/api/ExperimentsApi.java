...
public class ExperimentsApi {
   ...
   */
  public Experiment deleteExperiment(UUID expUUID) throws ApiException {
   ...
   */
  public ApiResponse<Experiment> deleteExperimentWithHttpInfo(UUID expUUID) throws ApiException {
   ...
   */
  public Experiment getExperiment(UUID expUUID) throws ApiException {
   ...
   */
  public ApiResponse<Experiment> getExperimentWithHttpInfo(UUID expUUID) throws ApiException {
    // Check required parameters
    if (expUUID == null) {
   ...
   */
  public DataProvider getProvider(UUID expUUID, String outputId) throws ApiException {
   ...
   */
  public ApiResponse<DataProvider> getProviderWithHttpInfo(UUID expUUID, String outputId) throws ApiException {
    // Check required parameters
    if (expUUID == null) {
   ...
   */
  public List<DataProvider> getProviders(UUID expUUID) throws ApiException {
   ...
   */
  public ApiResponse<List<DataProvider>> getProvidersWithHttpInfo(UUID expUUID) throws ApiException {
    // Check required parameters
    if (expUUID == null) {
   ...
   */
  public Experiment postExperiment(ExperimentQueryParameters experimentQueryParameters) throws ApiException {
   ...
   */
  public ApiResponse<Experiment> postExperimentWithHttpInfo(ExperimentQueryParameters experimentQueryParameters) throws ApiException {
    // Check required parameters
