...
public class ConfigurationParameterDescriptor {
  ...
  public ConfigurationParameterDescriptor dataType(String dataType) {
  ...
  public ConfigurationParameterDescriptor keyName(String keyName) {
  ...
  public ConfigurationParameterDescriptor required(Boolean required) {
  ...
  public ConfigurationParameterDescriptor description(String description) {
