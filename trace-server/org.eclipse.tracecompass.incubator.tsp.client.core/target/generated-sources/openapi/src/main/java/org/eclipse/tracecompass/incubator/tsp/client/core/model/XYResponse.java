 ...
 */
@JsonPropertyOrder({
  XYResponse.JSON_PROPERTY_STATUS_MESSAGE,
  XYResponse.JSON_PROPERTY_STATUS,
  XYResponse.JSON_PROPERTY_MODEL
})
...
public class XYResponse {
  ...
  public XYResponse statusMessage(@javax.annotation.Nonnull String statusMessage) {
  ...
  public XYResponse status(@javax.annotation.Nonnull StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public XYResponse model(@javax.annotation.Nullable XYModel model) {
    this.model = model;
    return this;
  }
  ...
  @JsonProperty(JSON_PROPERTY_MODEL)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setModel(@javax.annotation.Nullable XYModel model) {
    this.model = model;
  }


  /**
   * Return true if this XYResponse object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    XYResponse xyResponse = (XYResponse) o;
    return Objects.equals(this.statusMessage, xyResponse.statusMessage) &&
        Objects.equals(this.status, xyResponse.status) &&
        Objects.equals(this.model, xyResponse.model);
  }
