...
public class XYResponse {
  ...
  public XYResponse statusMessage(String statusMessage) {
  ...
  public XYResponse status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public XYResponse model(XYModel model) {
    this.model = model;
    return this;
  }
  ...
  @JsonProperty(JSON_PROPERTY_MODEL)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setModel(XYModel model) {
    this.model = model;
  }
