...
public class StylesApi {
   ...
   */
  public StylesResponse getStyles(UUID expUUID, String outputId, OptionalQueryParameters optionalQueryParameters) throws ApiException {
   ...
   */
  public ApiResponse<StylesResponse> getStylesWithHttpInfo(UUID expUUID, String outputId, OptionalQueryParameters optionalQueryParameters) throws ApiException {
