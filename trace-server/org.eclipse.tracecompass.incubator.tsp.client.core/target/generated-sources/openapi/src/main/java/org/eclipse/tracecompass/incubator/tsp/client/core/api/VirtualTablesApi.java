...
public class VirtualTablesApi {
   ...
   */
  public TableColumnHeadersResponse getColumns(UUID expUUID, String outputId, OptionalQueryParameters optionalQueryParameters) throws ApiException {
   ...
   */
  public ApiResponse<TableColumnHeadersResponse> getColumnsWithHttpInfo(UUID expUUID, String outputId, OptionalQueryParameters optionalQueryParameters) throws ApiException {
   ...
   */
  public VirtualTableResponse getLines(UUID expUUID, String outputId, LinesQueryParameters linesQueryParameters) throws ApiException {
   ...
   */
  public ApiResponse<VirtualTableResponse> getLinesWithHttpInfo(UUID expUUID, String outputId, LinesQueryParameters linesQueryParameters) throws ApiException {
    // Check required parameters
    if (expUUID == null) {
