...
public class RequestedParameters {
  ...
  public RequestedParameters filterQueryParameters(RequestedFilterQueryParameters filterQueryParameters) {
  ...
  public RequestedParameters requestedTimerange(TimeRange requestedTimerange) {
  ...
  public RequestedParameters requestedItems(List<Integer> requestedItems) {
