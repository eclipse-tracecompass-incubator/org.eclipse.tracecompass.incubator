...
public class DataTreeEntry {
  ...
  public DataTreeEntry hasData(Boolean hasData) {
  ...
  public DataTreeEntry parentId(Long parentId) {
  ...
  public DataTreeEntry style(OutputElementStyle style) {
    this.style = style;
    return this;
  }
  ...
  public DataTreeEntry id(Long id) {
    this.id = id;
    return this;
  }
  ...
  public DataTreeEntry labels(List<String> labels) {
    this.labels = labels;
    return this;
  }
