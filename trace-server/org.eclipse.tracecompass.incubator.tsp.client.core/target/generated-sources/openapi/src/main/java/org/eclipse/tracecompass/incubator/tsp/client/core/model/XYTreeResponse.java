...
public class XYTreeResponse {
  ...
  public XYTreeResponse statusMessage(String statusMessage) {
  ...
  public XYTreeResponse status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public XYTreeResponse model(XYTreeEntryModel model) {
    this.model = model;
    return this;
  }
  ...
  @JsonProperty(JSON_PROPERTY_MODEL)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setModel(XYTreeEntryModel model) {
    this.model = model;
  }
