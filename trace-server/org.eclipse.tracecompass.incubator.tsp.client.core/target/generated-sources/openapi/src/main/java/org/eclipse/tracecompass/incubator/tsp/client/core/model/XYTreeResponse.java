 ...
 */
@JsonPropertyOrder({
  XYTreeResponse.JSON_PROPERTY_STATUS_MESSAGE,
  XYTreeResponse.JSON_PROPERTY_STATUS,
  XYTreeResponse.JSON_PROPERTY_MODEL
})
...
public class XYTreeResponse {
  ...
  private XYTreeEntryModel model;

  public XYTreeResponse() { 
  }

  public XYTreeResponse statusMessage(@javax.annotation.Nonnull String statusMessage) {
  ...
  public XYTreeResponse status(@javax.annotation.Nonnull StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public XYTreeResponse model(@javax.annotation.Nullable XYTreeEntryModel model) {
    this.model = model;
    return this;
  }
  ...
  public XYTreeEntryModel getModel() {
    return model;
  }
  ...
  @JsonProperty(JSON_PROPERTY_MODEL)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setModel(@javax.annotation.Nullable XYTreeEntryModel model) {
    this.model = model;
  }


  /**
   * Return true if this XYTreeResponse object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    XYTreeResponse xyTreeResponse = (XYTreeResponse) o;
    return Objects.equals(this.statusMessage, xyTreeResponse.statusMessage) &&
        Objects.equals(this.status, xyTreeResponse.status) &&
        Objects.equals(this.model, xyTreeResponse.model);
  }
  ...
  public String toString() {
    ...
    sb.append("class XYTreeResponse {\n");
