...
public class XYTreeEntryModel {
  ...
  public XYTreeEntryModel autoExpandLevel(Integer autoExpandLevel) {
  ...
  public XYTreeEntryModel entries(List<XYTreeEntry> entries) {
  ...
  @JsonProperty(JSON_PROPERTY_ENTRIES)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setEntries(List<XYTreeEntry> entries) {
    this.entries = entries;
  }


  public XYTreeEntryModel headers(List<TreeColumnHeader> headers) {
