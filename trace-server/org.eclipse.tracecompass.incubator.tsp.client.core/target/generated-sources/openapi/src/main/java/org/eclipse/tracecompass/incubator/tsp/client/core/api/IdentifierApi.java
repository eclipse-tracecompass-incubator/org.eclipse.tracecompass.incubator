...
public class IdentifierApi {
  ...
  public IdentifierApi() {
    this(Configuration.getDefaultApiClient());
  }

  public IdentifierApi(ApiClient apiClient) {
   ...
   * @http.response.details
     <table border="1">
       ...
       <tr><td> 200 </td><td> Successfully retrieved the system and server information </td><td>  -  </td></tr>
     </table>
   */
  public ServerInfoResponse getSystemInfo() throws ApiException {
   ...
   */
  public ApiResponse<ServerInfoResponse> getSystemInfoWithHttpInfo() throws ApiException {
    String localVarAccept = apiClient.selectHeaderAccept("application/json");
    String localVarContentType = apiClient.selectHeaderContentType();
    GenericType<ServerInfoResponse> localVarReturnType = new GenericType<ServerInfoResponse>() {};
    return apiClient.invokeAPI("IdentifierApi.getSystemInfo", "/identifier", "GET", new ArrayList<>(), null,
