...
public class VirtualTableModel {
  ...
  public VirtualTableModel columnIds(List<Long> columnIds) {
  ...
  public VirtualTableModel lowIndex(Long lowIndex) {
  ...
  public VirtualTableModel lines(List<VirtualTableLine> lines) {
    this.lines = lines;
    return this;
  }
  ...
  @JsonProperty(JSON_PROPERTY_LINES)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setLines(List<VirtualTableLine> lines) {
    this.lines = lines;
  }


  public VirtualTableModel size(Long size) {
    this.size = size;
    return this;
  }
