...
public class DataTreeEntryModel {
  ...
  public DataTreeEntryModel autoExpandLevel(Integer autoExpandLevel) {
  ...
  public DataTreeEntryModel entries(List<DataTreeEntry> entries) {
  ...
  @JsonProperty(JSON_PROPERTY_ENTRIES)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setEntries(List<DataTreeEntry> entries) {
    this.entries = entries;
  }


  public DataTreeEntryModel headers(List<TreeColumnHeader> headers) {
