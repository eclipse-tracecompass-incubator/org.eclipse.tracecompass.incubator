...
public class ConfigurationQueryParameters {
  ...
  public ConfigurationQueryParameters description(String description) {
  ...
  public ConfigurationQueryParameters name(String name) {
    this.name = name;
    return this;
  }
  ...
  public ConfigurationQueryParameters parameters(Map<String, Object> parameters) {
