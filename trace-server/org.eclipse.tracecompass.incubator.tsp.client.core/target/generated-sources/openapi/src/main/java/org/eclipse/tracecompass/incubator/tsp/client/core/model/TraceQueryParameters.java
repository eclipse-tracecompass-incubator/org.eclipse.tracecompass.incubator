...
public class TraceQueryParameters {
  ...
  public TraceQueryParameters parameters(@javax.annotation.Nonnull TraceParameters parameters) {
  ...
  @JsonProperty(JSON_PROPERTY_PARAMETERS)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setParameters(@javax.annotation.Nonnull TraceParameters parameters) {
    this.parameters = parameters;
  }


  /**
   * Return true if this TraceQueryParameters object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    TraceQueryParameters traceQueryParameters = (TraceQueryParameters) o;
    return Objects.equals(this.parameters, traceQueryParameters.parameters);
  }
  ...
  public String toString() {
    ...
    sb.append("class TraceQueryParameters {\n");
