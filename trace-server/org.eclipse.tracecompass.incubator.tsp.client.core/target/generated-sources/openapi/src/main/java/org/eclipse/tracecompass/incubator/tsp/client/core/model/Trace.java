...
public class Trace {
  ...
  public Trace nbEvents(Long nbEvents) {
  ...
  public Trace indexingStatus(IndexingStatusEnum indexingStatus) {
  ...
  public Trace properties(Map<String, String> properties) {
