...
public class TooltipParameters {
  ...
  public TooltipParameters requestedElement(Element requestedElement) {
  ...
  @JsonProperty(JSON_PROPERTY_REQUESTED_ELEMENT)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setRequestedElement(Element requestedElement) {
    this.requestedElement = requestedElement;
  }


  public TooltipParameters requestedItems(List<Integer> requestedItems) {
  ...
  public TooltipParameters requestedTimes(List<Long> requestedTimes) {
