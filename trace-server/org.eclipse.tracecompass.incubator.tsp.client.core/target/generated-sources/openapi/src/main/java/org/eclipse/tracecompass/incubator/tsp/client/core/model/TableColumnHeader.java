...
public class TableColumnHeader {
  ...
  public TableColumnHeader description(String description) {
  ...
  public TableColumnHeader name(String name) {
    this.name = name;
    return this;
  }
  ...
  public TableColumnHeader id(Long id) {
    this.id = id;
    return this;
  }
  ...
  public TableColumnHeader type(String type) {
    this.type = type;
    return this;
  }
