...
public class TimeGraphEntry {
  ...
  public TimeGraphEntry hasData(Boolean hasData) {
  ...
  public TimeGraphEntry parentId(Long parentId) {
  ...
  public TimeGraphEntry style(OutputElementStyle style) {
    this.style = style;
    return this;
  }
  ...
  public TimeGraphEntry id(Long id) {
    this.id = id;
    return this;
  }
  ...
  public TimeGraphEntry labels(List<String> labels) {
    this.labels = labels;
    return this;
  }
  ...
  public TimeGraphEntry end(Long end) {
    this.end = end;
    return this;
  }
  ...
  public TimeGraphEntry metadata(Map<String, List<MetadataValue>> metadata) {
  ...
  @JsonProperty(JSON_PROPERTY_METADATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setMetadata(Map<String, List<MetadataValue>> metadata) {
    this.metadata = metadata;
  }


  public TimeGraphEntry start(Long start) {
    this.start = start;
    return this;
  }
