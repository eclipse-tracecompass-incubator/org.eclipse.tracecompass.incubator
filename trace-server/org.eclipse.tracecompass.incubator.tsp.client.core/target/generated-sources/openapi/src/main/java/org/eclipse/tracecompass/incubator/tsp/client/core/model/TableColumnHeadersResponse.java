...
public class TableColumnHeadersResponse {
  ...
  public TableColumnHeadersResponse statusMessage(String statusMessage) {
  ...
  public TableColumnHeadersResponse status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public TableColumnHeadersResponse model(List<TableColumnHeader> model) {
    this.model = model;
    return this;
  }
  ...
  @JsonProperty(JSON_PROPERTY_MODEL)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setModel(List<TableColumnHeader> model) {
    this.model = model;
  }
