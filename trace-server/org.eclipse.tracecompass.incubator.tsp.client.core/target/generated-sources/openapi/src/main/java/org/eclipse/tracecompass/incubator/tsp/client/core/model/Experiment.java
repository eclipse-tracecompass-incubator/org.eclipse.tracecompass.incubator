...
public class Experiment {
  ...
  public Experiment traces(List<Trace> traces) {
    this.traces = traces;
    return this;
  }
  ...
  public Experiment end(Long end) {
    this.end = end;
    return this;
  }
  ...
  public Experiment nbEvents(Long nbEvents) {
  ...
  public Experiment indexingStatus(IndexingStatusEnum indexingStatus) {
  ...
  public Experiment start(Long start) {
    this.start = start;
    return this;
  }
  ...
  public Experiment uuid(UUID uuid) {
    this.uuid = uuid;
    return this;
  }
