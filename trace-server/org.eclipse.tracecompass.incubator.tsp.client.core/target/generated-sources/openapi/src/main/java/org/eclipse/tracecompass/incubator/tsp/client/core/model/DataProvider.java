...
public class DataProvider {
  ...
  public DataProvider parentId(String parentId) {
  ...
  public DataProvider type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public DataProvider _configuration(ModelConfiguration _configuration) {
  ...
  public DataProvider capabilities(OutputCapabilities capabilities) {
  ...
  @JsonProperty(JSON_PROPERTY_CAPABILITIES)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setCapabilities(OutputCapabilities capabilities) {
    this.capabilities = capabilities;
  }
