 ...
 */
@JsonPropertyOrder({
  ExperimentQueryParameters.JSON_PROPERTY_PARAMETERS
})
...
public class ExperimentQueryParameters {
  public static final String JSON_PROPERTY_PARAMETERS = "parameters";
  @javax.annotation.Nonnull
  private ExperimentParameters parameters;

  public ExperimentQueryParameters() { 
  }

  public ExperimentQueryParameters parameters(@javax.annotation.Nonnull ExperimentParameters parameters) {
  ...
  @JsonProperty(JSON_PROPERTY_PARAMETERS)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setParameters(@javax.annotation.Nonnull ExperimentParameters parameters) {
    this.parameters = parameters;
  }


  /**
   * Return true if this ExperimentQueryParameters object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    ExperimentQueryParameters experimentQueryParameters = (ExperimentQueryParameters) o;
    return Objects.equals(this.parameters, experimentQueryParameters.parameters);
  }
  ...
  public String toString() {
    ...
    sb.append("class ExperimentQueryParameters {\n");
