...
public class AggregatedCalledFunction extends AggregatedCallSite {
    ...
    public Map<String, IStatistics<ICalledFunction>> getStatistics() {
        ...
        builder.put("Duration", getFunctionStatistics().getDurationStatistics());
        builder.put("Cpu time", getFunctionStatistics().getCpuTimesStatistics());
        builder.put("Self time", getFunctionStatistics().getSelfTimeStatistics());
