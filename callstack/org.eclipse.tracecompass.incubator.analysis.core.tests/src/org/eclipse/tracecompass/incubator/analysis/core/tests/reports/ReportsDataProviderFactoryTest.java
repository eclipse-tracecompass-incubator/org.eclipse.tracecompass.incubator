...
public class ReportsDataProviderFactoryTest {
    ...
    public static void beforeClass() {
        ...
        trace.traceOpened(new TmfTraceOpenedSignal(new ReportsDataProviderFactoryTest(), trace, null));
        fTrace = trace;
    }
    ...
    public void setUp() {
        ...
        TmfSignalManager.register(fFactory);
    }
    ...
    public void tearDown() {
        ...
        TmfSignalManager.deregister(fFactory);
        fFactory.dispose();
        fFactory = null;
    }
