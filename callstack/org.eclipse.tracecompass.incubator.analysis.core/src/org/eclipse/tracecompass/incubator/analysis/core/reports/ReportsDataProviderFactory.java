...
public class ReportsDataProviderFactory implements IDataProviderFactory, ITmfDataProviderConfigurator, IReportDataProvider {
    ...
    private static final String PARENT_ID_DESC = "ID of the parent report"; //$NON-NLS-1$
    ...
    public @NonNull List<@NonNull ITmfConfigurationSourceType> getConfigurationSourceTypes() {
        ...
        // Add base configuration source type with the common descriptors
        List<ITmfConfigParamDescriptor> baseDescriptors = new ArrayList<>(CONFIGURATION_SOURCE_TYPE.getConfigParamDescriptors());
        baseDescriptors.addAll(List.of(
                new TmfConfigParamDescriptor.Builder()
                        .setKeyName(REPORT_TYPE)
                        .setDescription(NLS.bind(REPORT_TYPE_DESC, ProviderType.NONE.name().toUpperCase()))
                        .setIsRequired(true)
                        .build(),
                new TmfConfigParamDescriptor.Builder()
        ...
        result.add(new TmfConfigurationSourceType.Builder()
                .setName(CONFIGURATION_SOURCE_TYPE.getName())
                .setDescription(CONFIGURATION_SOURCE_TYPE.getDescription())
                .setId(CONFIGURATION_SOURCE_TYPE.getId())
                .setConfigParamDescriptors(baseDescriptors)
                .build());

        // Add provider configuration types with the same descriptor structure
