...
public class PerfDataCallchainAnalysisModule extends ProfilingCallGraphAnalysisModule
    ...
    private final @NonNull CallStackGroupDescriptor fThreadDescriptor;
    private final @NonNull CallStackGroupDescriptor fProcessDescriptor;
    ...
    protected @Nullable Pair<@NonNull ICallStackElement, @NonNull AggregatedCallSite> getProfiledStackTrace(@NonNull ITmfEvent event) {
        ...
        @NonNull ICallStackElement element = getElement(event);
    ...
    private static int extractInt(ITmfEvent event, @NonNull String field, int defaultValue) {
        Object value = event.getContent().getValue();
        if (value instanceof PerfRecord) {
    ...
    private @NonNull ICallStackElement getElement(@NonNull ITmfEvent event) {
        ...
        if (!process.isPresent()) {
            processEl = new CallStackElement(String.valueOf(pid),
    ...
    private final class PerfSamplingRequest extends TmfEventRequest {
        ...
        @Override
        public void handleData(final @NonNull ITmfEvent event) {
        ...
        private void handleEvent(@NonNull ITmfEvent event) {
