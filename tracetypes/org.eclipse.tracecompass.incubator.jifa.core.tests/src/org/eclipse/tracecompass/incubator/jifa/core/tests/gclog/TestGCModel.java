...
public class TestGCModel {
    ...
    public void mockModel() {
        fModel = new G1GCModel();
        fModel.setHeapRegionSize(1024 * 1024);
        fModel.setCollectorType(GCCollectorType.G1);
        fModel.setLogStyle(GCLogStyle.PRE_UNIFIED);
        fModel.setHeapRegionSize(1024 * 1024);
        fModel.setStartTime(1.0 * 1000);
        fModel.setParallelThread(8);
        fModel.setVmOptions(new VmOptions("-Xmx2g -Xms2g"));
        fModel.setReferenceTimestamp(1000.0);

        GCEvent[] events = new GCEvent[6];
        for (int i = 0; i < 6; i++) {
            events[i] = fModel.createAndGetEvent();
        }
        ...
        events[0].setMemoryItem(new GCMemoryItem(MemoryArea.EDEN, 20 * 1024 * 1024, 0, 100 * 1024 * 1024));
        events[0].setMemoryItem(new GCMemoryItem(MemoryArea.SURVIVOR, 0, 10 * 1024 * 1024, 100 * 1024 * 1024));
        events[0].setMemoryItem(new GCMemoryItem(MemoryArea.HUMONGOUS, 10 * 1024 * 1024, 10 * 1024 * 1024, Constant.UNKNOWN_INT));
        events[0].setMemoryItem(new GCMemoryItem(MemoryArea.METASPACE, 15 * 1024 * 1024, 15 * 1024 * 1024, 20 * 1024 * 1024));
        events[0].setMemoryItem(new GCMemoryItem(MemoryArea.OLD, 10 * 1024 * 1024, 12 * 1024 * 1024, 100 * 1024 * 1024));
...
//      expected result:  collectionResult.addItem(new GCCollectionResultItem(TOTAL,40*1024,32*1024,300*1024));
        ...
        events[1].setMemoryItem(new GCMemoryItem(MemoryArea.EDEN, 30 * 1024 * 1024, 0, 100 * 1024 * 1024));
        events[1].setMemoryItem(new GCMemoryItem(MemoryArea.SURVIVOR, 0, 0, 100 * 1024 * 1024));
        events[1].setMemoryItem(new GCMemoryItem(MemoryArea.HUMONGOUS, 10 * 1024 * 1024, 10 * 1024 * 1024, Constant.UNKNOWN_INT));
        events[1].setMemoryItem(new GCMemoryItem(MemoryArea.OLD, 10 * 1024 * 1024, 30 * 1024 * 1024, 100 * 1024 * 1024));
//      expected result:  events[1].setMemoryItem(new GCCollectionResultItem(HEAP,50,40,300));

        events[2].setEventType(GCEventType.FULL_GC);
        events[2].setStartTime(12.0 * 1000);
        events[2].setDuration(1.0 * 1000);
        events[2].setCause("Metadata GC Threshold");
        events[2].setMemoryItem(new GCMemoryItem(MemoryArea.EDEN, 24 * 1024 * 1024, 0, 100 * 1024 * 1024));
        events[2].setMemoryItem(new GCMemoryItem(MemoryArea.SURVIVOR, 8 * 1024 * 1024, 0, 100 * 1024 * 1024));
        events[2].setMemoryItem(new GCMemoryItem(MemoryArea.HUMONGOUS, 20 * 1024 * 1024, 20 * 1024 * 1024, Constant.UNKNOWN_INT));
        events[2].setMemoryItem(new GCMemoryItem(MemoryArea.OLD, 10 * 1024 * 1024, 10 * 1024 * 1024, 100 * 1024 * 1024));
        events[2].setMemoryItem(new GCMemoryItem(MemoryArea.HEAP, 62 * 1024 * 1024, 30 * 1024 * 1024, 300 * 1024 * 1024));

        events[3].setEventType(GCEventType.G1_CONCURRENT_CYCLE);
        events[3].setStartTime(16.0 * 1000);
        events[3].setDuration(1.2 * 1000);
        GCEventType[] concurrentCyclePhases = {GCEventType.G1_REMARK, GCEventType.G1_PAUSE_CLEANUP, GCEventType.G1_CONCURRENT_CLEAR_CLAIMED_MARKS};
        double[] begins = {16.0, 16.2, 16.6};
        for (int i = 0; i < concurrentCyclePhases.length; i++) {
            GCEvent phase = new GCEvent();
            phase.setGcid(4);
            fModel.addPhase(events[3], phase);
            phase.setEventType(concurrentCyclePhases[i]);
            phase.setDuration(0.2 * (i + 1) * 1000);
            phase.setStartTime(begins[i] * 1000);
        }
        events[3].getPhases().get(0).setMemoryItem(new GCMemoryItem(MemoryArea.HEAP, 70 * 1024 * 1024, 70 * 1024 * 1024, 300 * 1024 * 1024));
        events[3].getPhases().get(1).setMemoryItem(new GCMemoryItem(MemoryArea.HEAP, 70 * 1024 * 1024, 70 * 1024 * 1024, 300 * 1024 * 1024));

        events[4].setEventType(GCEventType.G1_CONCURRENT_CYCLE);
        events[4].setStartTime(24 * 1000);
        events[4].setDuration(0.6 * 1000);
        concurrentCyclePhases = new GCEventType[]{GCEventType.G1_REMARK, GCEventType.G1_PAUSE_CLEANUP, GCEventType.G1_CONCURRENT_CLEAR_CLAIMED_MARKS};
        begins = new double[]{24.0, 24.1, 24.3};
        for (int i = 0; i < concurrentCyclePhases.length; i++) {
            GCEvent phase = new GCEvent();
            phase.setGcid(5);
            fModel.addPhase(events[4], phase);
            phase.setEventType(concurrentCyclePhases[i]);
            phase.setDuration(0.1 * (i + 1) * 1000);
            phase.setStartTime(begins[i] * 1000);
        }
        events[4].getPhases().get(0).setMemoryItem(new GCMemoryItem(MemoryArea.HEAP, 70 * 1024 * 1024, 70 * 1024 * 1024, 300 * 1024 * 1024));
        events[4].getPhases().get(1).setMemoryItem(new GCMemoryItem(MemoryArea.HEAP, 70 * 1024 * 1024, 70 * 1024 * 1024, 300 * 1024 * 1024));

        events[5].setEventType(GCEventType.YOUNG_GC);
        events[5].setStartTime(32.0 * 1000);
        events[5].setDuration(0.3 * 1000);
        events[5].setCause("G1 Evacuation Pause");
        events[5].setMemoryItem(new GCMemoryItem(MemoryArea.EDEN, 16 * 1024 * 1024, 0, 100 * 1024 * 1024));
        events[5].setMemoryItem(new GCMemoryItem(MemoryArea.SURVIVOR, 0, 4 * 1024 * 1024, 100 * 1024 * 1024));
        events[5].setMemoryItem(new GCMemoryItem(MemoryArea.HUMONGOUS, 50 * 1024 * 1024, 50 * 1024 * 1024, Constant.UNKNOWN_INT));
        events[5].setMemoryItem(new GCMemoryItem(MemoryArea.METASPACE, 15 * 1024 * 1024, 15 * 1024 * 1024, 40 * 1024 * 1024));
//      expected result:  events[5].setMemoryItem(new GCCollectionResultItem(OLD,10,12,100));
        events[5].setMemoryItem(new GCMemoryItem(MemoryArea.HEAP, 76 * 1024 * 1024, 66 * 1024 * 1024, 300 * 1024 * 1024));
        ...
        fModel.addSafepoint(safepoint);
    }

    @Test
    public void testModelMisc() {
        fModel.calculateDerivedInfo(new NullProgressMonitor());

        // derived model info
        Assert.assertEquals(fModel.getEndTime(), 32.3 * 1000, DELTA);
        Assert.assertEquals(fModel.getGcCollectionEvents().size(), 8);

        // single event info
        Assert.assertEquals(fModel.getGcEvents().get(0).getAllocation(), 40 * 1024 * 1024);
        Assert.assertEquals(fModel.getGcEvents().get(0).getPromotion(), 2 * 1024 * 1024);
        Assert.assertEquals(fModel.getGcEvents().get(0).getReclamation(), 8 * 1024 * 1024);
        Assert.assertEquals(fModel.getGcEvents().get(3).getPause(), 0.6 * 1000, DELTA);
        Assert.assertEquals(fModel.getGcEvents().get(4).getPause(), 0.3 * 1000, DELTA);
        Assert.assertEquals(fModel.getGcEvents().get(0).getMemoryItem(MemoryArea.HEAP),
                new GCMemoryItem(MemoryArea.HEAP, 40 * 1024 * 1024, 32 * 1024 * 1024, 300 * 1024 * 1024));
        Assert.assertEquals(fModel.getGcEvents().get(5).getMemoryItem(MemoryArea.OLD),
                new GCMemoryItem(MemoryArea.OLD, 10 * 1024 * 1024, 12 * 1024 * 1024, 100 * 1024 * 1024));
        Assert.assertEquals(fModel.getGcEvents().get(4).getInterval(), 6.8 * 1000, DELTA);

        // object statistics
        ObjectStatistics objectStatistics = fModel.getObjectStatistics(new TimeRange(500, 33000));
        ...
        // pause statistics
        PauseStatistics pauseStatistics = fModel.getPauseStatistics(new TimeRange(10000, 30000));
        ...
        // pause Distribution
        Map<String, int[]> pauseDistribution = fModel.getPauseDistribution(new TimeRange(10000, 30000), new int[]{0, 300});
        Assert.assertArrayEquals(pauseDistribution.get(GCEventType.FULL_GC.getName()), new int[]{0, 1});
        Assert.assertArrayEquals(pauseDistribution.get(GCEventType.G1_REMARK.getName()), new int[]{2, 0});
        Assert.assertArrayEquals(pauseDistribution.get(GCEventType.G1_PAUSE_CLEANUP.getName()), new int[]{1, 1});

        // phase statistics
        List<PhaseStatistics.ParentStatisticsInfo> parents = fModel.getPhaseStatistics(new TimeRange(0, 999999999)).getParents();
        ...
        Assert.assertEquals(parents.get(1).getSelf(), new PhaseStatistics.PhaseStatisticItem(
                GCEventType.G1_CONCURRENT_CYCLE.getName(), 2, 6800, 6800, 900, 1200, 1800));
        ...
        Assert.assertEquals(parents.get(1).getPhases().get(1), new PhaseStatistics.PhaseStatisticItem(
                GCEventType.G1_REMARK.getName(), 2, 7800, 7800, 150, 200, 300));

        Map<String, List<Object[]>> graphData = fModel.getTimeGraphData(new String[]{"youngCapacity", "heapUsed", "reclamation", "promotion", GCEventType.G1_REMARK.getName()});
        Assert.assertEquals(graphData.size(), 5);

        List<Object[]> youngCapacity = graphData.get("youngCapacity");
        assertNotNull(youngCapacity);
        ...
        List<Object[]> remark = graphData.get(GCEventType.G1_REMARK.getName());
    ...
    public void testUseCPUTimeAsPause() throws Exception {
        ...
        PreUnifiedG1GCLogParser parser = (PreUnifiedG1GCLogParser)
                (new GCLogParserFactory().getParser(TestUtil.stringToBufferedReader(log)));

        G1GCModel model = (G1GCModel) parser.parse(TestUtil.stringToBufferedReader(log));
    ...
    public void testCauseInterval() throws Exception {
        ...
        GCLogParser parser = new GCLogParserFactory().getParser(TestUtil.stringToBufferedReader(log));
        GCModel model = parser.parse(TestUtil.stringToBufferedReader(log));
        model.calculateDerivedInfo(new NullProgressMonitor());

        Assert.assertEquals(model.getGcEvents().get(3).getCauseInterval(), Constant.UNKNOWN_DOUBLE, DELTA);
        ...
        for (PhaseStatistics.ParentStatisticsInfo parent : parents) {
            if (parent.getSelf().getName().equals(GCEventType.FULL_GC.getName())) {
