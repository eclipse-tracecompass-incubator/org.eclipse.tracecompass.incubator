...
/**
 * Factory for the flows data provider
 *
 * @author Yoann Heitz
 */
public class Otf2FlowsDataProviderFactory implements IDataProviderFactory {
    ...
    public @Nullable ITmfTreeDataProvider<? extends ITmfTreeDataModel> createProvider(ITmfTrace trace) {
        ...
        if (module != null) {
            module.schedule();
            return new Otf2FlowsDataProvider(trace, module);
        }
        return null;
    }
