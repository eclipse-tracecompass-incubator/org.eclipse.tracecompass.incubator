...
/**
 * ROS 2 message flow presentation provider.
 *
 * TODO find a way to extract code shared with
 * {@link Ros2MessagesPresentationProvider}
 *
 * @author Christophe Bedard
 */
public class Ros2MessageFlowPresentationProvider extends TimeGraphPresentationProvider {
    ...
    static {
        ...
        STATE_TABLE[1] = new StateItem(State.ARROW_CALLBACK_PUB.rgb, State.ARROW_CALLBACK_PUB.toString());
        STATE_TABLE[2] = new StateItem(State.ARROW_WAIT.rgb, State.ARROW_WAIT.toString());
        int i = 0;
    ...
    private enum State {
        ARROW_TRANSPORT(new RGB(0x26, 0x26, 0x26)), ARROW_CALLBACK_PUB(new RGB(0x80, 0x80, 0x80)), ARROW_WAIT(new RGB(0x80, 0x1, 0x1));
    ...
    public int getStateTableIndex(ITimeEvent event) {
        if (event instanceof TimeEvent) {
            ...
            } else if (timeEvent.getValue() == ArrowType.WAIT.getId()) {
