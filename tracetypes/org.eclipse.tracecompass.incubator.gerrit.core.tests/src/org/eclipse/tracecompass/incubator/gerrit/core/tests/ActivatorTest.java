...
package org.eclipse.tracecompass.incubator.gerrit.core.tests;
...
import org.eclipse.tracecompass.incubator.internal.gerrit.core.Activator;
...
public class ActivatorTest extends Plugin {
     ...
     * The plug-in ID
     */
    public static final String PLUGIN_ID = "org.eclipse.tracecompass.incubator.gerrit.core.tests"; //$NON-NLS-1$
    ...
    public void testActivator() {
        ...
        assertEquals("org.eclipse.tracecompass.incubator.gerrit.core", instance.getPluginId());
    }
