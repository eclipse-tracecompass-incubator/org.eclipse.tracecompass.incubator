...
package org.eclipse.tracecompass.incubator.internal.syslog.core;
...
public class Activator extends TraceCompassActivator {
    ...
    /** The plug-in ID */
    public static final String PLUGIN_ID = "org.eclipse.tracecompass.incubator.structuredtext.core"; //$NON-NLS-1$
