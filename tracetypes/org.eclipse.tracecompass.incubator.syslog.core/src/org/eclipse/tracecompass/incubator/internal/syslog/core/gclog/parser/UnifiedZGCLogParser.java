...
import org.eclipse.tracecompass.incubator.internal.syslog.core.gclog.model.ZGCModel;
import org.eclipse.tracecompass.incubator.internal.syslog.core.gclog.model.ZGCModel.ZStatistics;
...
import static org.eclipse.tracecompass.incubator.internal.syslog.core.gclog.model.GCEventType.ZGC_ALLOCATION_STALL;
...
import static org.eclipse.tracecompass.incubator.internal.syslog.core.gclog.model.GCEventType.ZGC_CONCURRENT_MARK;
import static org.eclipse.tracecompass.incubator.internal.syslog.core.gclog.model.GCEventType.ZGC_CONCURRENT_NONREF;
import static org.eclipse.tracecompass.incubator.internal.syslog.core.gclog.model.GCEventType.ZGC_CONCURRENT_PREPARE_RELOC_SET;
import static org.eclipse.tracecompass.incubator.internal.syslog.core.gclog.model.GCEventType.ZGC_CONCURRENT_RELOCATE;
import static org.eclipse.tracecompass.incubator.internal.syslog.core.gclog.model.GCEventType.ZGC_CONCURRENT_RESET_RELOC_SET;
import static org.eclipse.tracecompass.incubator.internal.syslog.core.gclog.model.GCEventType.ZGC_CONCURRENT_SELECT_RELOC_SET;
import static org.eclipse.tracecompass.incubator.internal.syslog.core.gclog.model.GCEventType.ZGC_GARBAGE_COLLECTION;
import static org.eclipse.tracecompass.incubator.internal.syslog.core.gclog.model.GCEventType.ZGC_PAUSE_MARK_END;
import static org.eclipse.tracecompass.incubator.internal.syslog.core.gclog.model.GCEventType.ZGC_PAUSE_MARK_START;
import static org.eclipse.tracecompass.incubator.internal.syslog.core.gclog.model.GCEventType.ZGC_PAUSE_RELOCATE_START;
import static org.eclipse.tracecompass.incubator.internal.syslog.core.gclog.parser.ParseRule.ParseRuleContext.GCID;
import static org.eclipse.tracecompass.incubator.internal.syslog.core.gclog.parser.ParseRule.ParseRuleContext.UPTIME;
...
public class UnifiedZGCLogParser extends AbstractUnifiedGCLogParser {
     ...
     * [2021-08-31T08:08:17.471+0800] GC(374) Reclaimed:         -                  -               754M (2%)         4200M (10%)            -                  -
     */
    private static void parseHeap(AbstractGCLogParser parser, ParseRule.ParseRuleContext context, String prefix1, String value) {
        GCModel model = parser.getModel();
