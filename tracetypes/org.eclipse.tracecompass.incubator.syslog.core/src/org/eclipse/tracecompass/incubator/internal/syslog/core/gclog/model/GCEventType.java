...
import static org.eclipse.tracecompass.incubator.internal.syslog.core.gclog.event.eventInfo.GCPause.CONCURRENT;
import static org.eclipse.tracecompass.incubator.internal.syslog.core.gclog.event.eventInfo.GCPause.PARTIAL;
import static org.eclipse.tracecompass.incubator.internal.syslog.core.gclog.event.eventInfo.GCPause.PAUSE;
...
public class GCEventType {
    ...
    public void setPause(GCPause pause) {
        this.pause = pause;
    }
}
