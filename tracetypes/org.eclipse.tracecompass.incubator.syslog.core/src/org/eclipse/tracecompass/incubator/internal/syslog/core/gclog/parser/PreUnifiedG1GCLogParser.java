...
package org.eclipse.tracecompass.incubator.internal.syslog.core.gclog.parser;

import static org.eclipse.tracecompass.incubator.internal.syslog.core.gclog.model.GCEventType.FULL_GC;
import static org.eclipse.tracecompass.incubator.internal.syslog.core.gclog.model.GCEventType.G1_CHOOSE_CSET;
import static org.eclipse.tracecompass.incubator.internal.syslog.core.gclog.model.GCEventType.G1_CLEAR_CT;
import static org.eclipse.tracecompass.incubator.internal.syslog.core.gclog.model.GCEventType.G1_CODE_ROOT_FIXUP;
import static org.eclipse.tracecompass.incubator.internal.syslog.core.gclog.model.GCEventType.G1_CODE_ROOT_PURGE;
import static org.eclipse.tracecompass.incubator.internal.syslog.core.gclog.model.GCEventType.G1_CODE_ROOT_SCANNING;
import static org.eclipse.tracecompass.incubator.internal.syslog.core.gclog.model.GCEventType.G1_CONCURRENT_CLEANUP_FOR_NEXT_MARK;
import static org.eclipse.tracecompass.incubator.internal.syslog.core.gclog.model.GCEventType.G1_CONCURRENT_CYCLE;
import static org.eclipse.tracecompass.incubator.internal.syslog.core.gclog.model.GCEventType.G1_CONCURRENT_MARK;
import static org.eclipse.tracecompass.incubator.internal.syslog.core.gclog.model.GCEventType.G1_CONCURRENT_MARK_ABORT;
import static org.eclipse.tracecompass.incubator.internal.syslog.core.gclog.model.GCEventType.G1_CONCURRENT_MARK_RESET_FOR_OVERFLOW;
import static org.eclipse.tracecompass.incubator.internal.syslog.core.gclog.model.GCEventType.G1_CONCURRENT_SCAN_ROOT_REGIONS;
import static org.eclipse.tracecompass.incubator.internal.syslog.core.gclog.model.GCEventType.G1_EVACUATION_FAILURE;
import static org.eclipse.tracecompass.incubator.internal.syslog.core.gclog.model.GCEventType.G1_EXT_ROOT_SCANNING;
import static org.eclipse.tracecompass.incubator.internal.syslog.core.gclog.model.GCEventType.G1_FINALIZE_MARKING;
import static org.eclipse.tracecompass.incubator.internal.syslog.core.gclog.model.GCEventType.G1_FREE_CSET;
import static org.eclipse.tracecompass.incubator.internal.syslog.core.gclog.model.GCEventType.G1_GC_REFPROC;
import static org.eclipse.tracecompass.incubator.internal.syslog.core.gclog.model.GCEventType.G1_HUMONGOUS_RECLAIM;
import static org.eclipse.tracecompass.incubator.internal.syslog.core.gclog.model.GCEventType.G1_HUMONGOUS_REGISTER;
import static org.eclipse.tracecompass.incubator.internal.syslog.core.gclog.model.GCEventType.G1_MIXED_GC;
import static org.eclipse.tracecompass.incubator.internal.syslog.core.gclog.model.GCEventType.G1_OBJECT_COPY;
import static org.eclipse.tracecompass.incubator.internal.syslog.core.gclog.model.GCEventType.G1_PAUSE_CLEANUP;
import static org.eclipse.tracecompass.incubator.internal.syslog.core.gclog.model.GCEventType.G1_REDIRTY_CARDS;
import static org.eclipse.tracecompass.incubator.internal.syslog.core.gclog.model.GCEventType.G1_REF_ENQ;
import static org.eclipse.tracecompass.incubator.internal.syslog.core.gclog.model.GCEventType.G1_REMARK;
import static org.eclipse.tracecompass.incubator.internal.syslog.core.gclog.model.GCEventType.G1_SCAN_RS;
import static org.eclipse.tracecompass.incubator.internal.syslog.core.gclog.model.GCEventType.G1_TERMINATION;
import static org.eclipse.tracecompass.incubator.internal.syslog.core.gclog.model.GCEventType.G1_UNLOADING;
import static org.eclipse.tracecompass.incubator.internal.syslog.core.gclog.model.GCEventType.G1_UPDATE_RS;
import static org.eclipse.tracecompass.incubator.internal.syslog.core.gclog.model.GCEventType.YOUNG_GC;
import static org.eclipse.tracecompass.incubator.internal.syslog.core.gclog.parser.ParseRule.ParseRuleContext.EVENT;

import java.util.ArrayList;
import java.util.List;

import org.eclipse.tracecompass.incubator.internal.syslog.core.gclog.event.GCEvent;
import org.eclipse.tracecompass.incubator.internal.syslog.core.gclog.event.eventInfo.GCEventBooleanType;
...
import org.eclipse.tracecompass.incubator.internal.syslog.core.gclog.model.GCEventType;
import org.eclipse.tracecompass.incubator.internal.syslog.core.gclog.model.GCModel;
import org.eclipse.tracecompass.incubator.internal.syslog.core.gclog.parser.ParseRule.FixedContentParseRule;
import org.eclipse.tracecompass.incubator.internal.syslog.core.gclog.parser.ParseRule.ParseRuleContext;
import org.eclipse.tracecompass.incubator.internal.syslog.core.gclog.parser.ParseRule.PrefixAndValueParseRule;
import org.eclipse.tracecompass.incubator.internal.syslog.core.gclog.util.GCLogUtil;
...
public class PreUnifiedG1GCLogParser extends AbstractPreUnifiedGCLogParser {
    ...
    private static void parseMemoryChange(AbstractGCLogParser parser, ParseRuleContext context, String prefix, String value) {
        ...
        for (int i = 0; i < parts.length; i += 2) {
            String areaString = strip(parts[i], "[:");
            MemoryArea area = MemoryArea.getMemoryArea(areaString);
            String memoryChangeString = strip(parts[i + 1], ",]");
