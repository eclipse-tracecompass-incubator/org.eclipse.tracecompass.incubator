...
import static org.eclipse.tracecompass.incubator.internal.syslog.core.gclog.model.GCEventType.CMS_CLASS_UNLOADING;
import static org.eclipse.tracecompass.incubator.internal.syslog.core.gclog.model.GCEventType.CMS_CONCURRENT_ABORTABLE_PRECLEAN;
import static org.eclipse.tracecompass.incubator.internal.syslog.core.gclog.model.GCEventType.CMS_CONCURRENT_FAILURE;
import static org.eclipse.tracecompass.incubator.internal.syslog.core.gclog.model.GCEventType.CMS_CONCURRENT_INTERRUPTED;
import static org.eclipse.tracecompass.incubator.internal.syslog.core.gclog.model.GCEventType.CMS_CONCURRENT_MARK;
import static org.eclipse.tracecompass.incubator.internal.syslog.core.gclog.model.GCEventType.CMS_CONCURRENT_MARK_SWEPT;
import static org.eclipse.tracecompass.incubator.internal.syslog.core.gclog.model.GCEventType.CMS_CONCURRENT_PRECLEAN;
import static org.eclipse.tracecompass.incubator.internal.syslog.core.gclog.model.GCEventType.CMS_CONCURRENT_RESET;
import static org.eclipse.tracecompass.incubator.internal.syslog.core.gclog.model.GCEventType.CMS_CONCURRENT_SWEEP;
import static org.eclipse.tracecompass.incubator.internal.syslog.core.gclog.model.GCEventType.CMS_FINAL_REMARK;
import static org.eclipse.tracecompass.incubator.internal.syslog.core.gclog.model.GCEventType.CMS_INITIAL_MARK;
import static org.eclipse.tracecompass.incubator.internal.syslog.core.gclog.model.GCEventType.CMS_RESCAN;
import static org.eclipse.tracecompass.incubator.internal.syslog.core.gclog.model.GCEventType.CMS_SCRUB_STRING_TABLE;
import static org.eclipse.tracecompass.incubator.internal.syslog.core.gclog.model.GCEventType.CMS_SCRUB_SYMBOL_TABLE;
import static org.eclipse.tracecompass.incubator.internal.syslog.core.gclog.model.GCEventType.FULL_GC;
import static org.eclipse.tracecompass.incubator.internal.syslog.core.gclog.model.GCEventType.WEAK_REFS_PROCESSING;
...
public class PreUnifiedGenerationalGCLogParser extends AbstractPreUnifiedGCLogParser {
    ...
    private static void parseCMSPhase(AbstractGCLogParser parser, ParseRuleContext context, String phaseName, String value) {
        ...
        if (phaseName.startsWith("GC (")) {
            // "GC (CMS Final Remark)"
            phaseLabel = phaseName.substring(4, phaseName.length() - 1);
        } else if (phaseName.startsWith(" (")) {
            // " (concurrent mode interrupted)"
            phaseLabel = phaseName.substring(2, phaseName.length() - 1);
        } else {
            phaseLabel = phaseName;
        }
        GCEventType phaseType = getGCEventType(phaseLabel);
