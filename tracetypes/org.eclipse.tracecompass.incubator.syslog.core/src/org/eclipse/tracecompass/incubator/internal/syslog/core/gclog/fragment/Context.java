 ...
 ********************************************************************************/
package org.eclipse.tracecompass.incubator.internal.syslog.core.gclog.fragment;
...
public class Context {
    ...
    */
    ...
    class ContextComparator implements Comparator<String> {
        ...
        Set<String> precedentPatternSet = Set.of("Pause Young", "Pause Initial Mark", "CMS Initial Mark", "Concurrent Cycle", "Concurrent Mark");
